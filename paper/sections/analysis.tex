...
None of these candidates pass SymPy verification; whether this reflects
arithmetic errors, domain constraint violations, or other failure modes
in the generated candidates is not directly observable from this data.
